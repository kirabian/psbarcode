@php
    ...
    // Warna tema internal (Light/Dark Mode)
...
<div class="d-flex flex-column align-items-center" style="background: transparent; padding: 0; margin: 0;">
    ...
    ">
        ...
        <div style="display: flex; justify-content: space-between; padding: 18px 30px 0 30px; align-items: center; width: 100%; box-sizing: border-box;">
            ...
            <div style="display: flex; gap: 6px; align-items: center;">
                ...
                <div style="width: 25px; height: 12px; border: 1px solid {{ $headerColor }}; border-radius: 3px; position: relative; padding: 1px; box-sizing: border-box;">
        ...
        <div style="flex-grow: 1; display: flex; flex-direction: column; align-items: center; padding-top: 10px;">
            ...
            <div style="margin-bottom: 30px; width: 100%; display: flex; flex-direction: column; align-items: center;">
                ...
                <div style="background: #ffffff; padding: 12px 10px; width: 90%; border-radius: 4px; display: flex; justify-content: center; box-sizing: border-box;">
    ...
    <div class="mt-4 d-flex gap-2">
        <button onclick="downloadCleanImage('{{ $id }}')" class="btn btn-primary rounded-pill px-4 fw-bold">
            Download JPG
        </button>
    </div>
</div>
...
<script>
function downloadCleanImage(id) {
    const element = document.getElementById('capture-area-' + id);
    
    // Konfigurasi html2canvas untuk menghindari background hitam
    html2canvas(element, {
        backgroundColor: null, // PENTING: Menghilangkan latar belakang di luar elemen target
